...
const numeral = new Number(100.1234);
// Output a number that has three decimals
console.log(numeral.toFixed(3));
// Output a number with length 4
console.log(numeral.toPrecision(4));
// Output a decimal number
console.log(numeral.toString());
// Output a binary number
console.log(numeral.toString(2));
// Output a hexadecimal number
console.log(numeral.toString(16));
